    ...
    const courseContents = [
        {
            ...
            introduction: {
                title: "사회복지사란?",
                contents:"사회복지사 2급은 사회적 돌봄이 필요한 계층을 지원하고, 복지 서비스를 향상하는 전문가 자격입니다. 국가 공인 자격으로, 사회복지 기관 및 공공기관 취업 시 필수 자격으로 인정받습니다."
            },
            points: {
                course: "사회복지사 2급",
        ...
        },
        {
            ...
            introduction: {
                title: "국가기술자격증이란?",
                contents:"국가기술자격증은 산업 현장에서 요구하는 실무 능력을 검증하는 국가 공인 자격입니다. 기술 분야에서 전문성을 갖추기 위해 필수적으로 요구되며, 취업 및 경력 개발에 큰 도움이 됩니다. 특히, 학점은행제를 통해 일정 학점을 취득하면 기사·산업기사 등의 응시자격을 갖출 수 있습니다."
            },
            points: {
                course: "국가기술자격증 응시자격",
                qualifications: "기사 : 학점은행제 106학점, 산업기사 : 학점은행제 41학점",
                proceed: "온라인 수업"
            },
            cta: {
        ...
        },
        {
            ...
            introduction: {
                title: "학위취득이란?",
                contents:"학위취득은 공식적인 학력을 인정받아 경력 개발 및 취업 경쟁력을 높이는 과정입니다. 학점은행제를 통해 전문학사(80학점), 학사(140학점) 취득이 가능하며, 기존 학습 이력을 활용해 효율적으로 학위를 취득할 수 있습니다. 특히, 편입·대학원 진학·공무원 응시 등 다양한 진로를 계획하는 분들에게 필수적인 과정입니다."
            },
            points: {
                course: "학위취득",
